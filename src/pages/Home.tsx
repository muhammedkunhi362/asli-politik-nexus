      ...
      <main className="flex-1">
        <section className="bg-gradient-hero py-20">
          <div className="container mx-auto px-4">
            <h1 className="text-3xl md:text-4xl lg:text-5xl leading-tight font-serif font-bold text-white animate-fade-in">
              Insightful Political Analysis &<br />
              Geopolitical Commentary
            </h1>
            <p className="mt-6 text-base md:text-lg text-gray-200 max-w-3xl animate-fade-in">
