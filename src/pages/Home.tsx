  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        <section className="bg-gradient-hero dark:bg-gray-900 py-20">
          <div className="container mx-auto px-4">
            <h1 className="text-3xl md:text-4xl lg:text-5xl leading-tight font-serif font-bold text-black dark:text-white animate-fade-in">
              Insightful Political Analysis &<br />
              Geopolitical Commentary
            </h1>
            <p className="mt-6 text-base md:text-lg text-gray-700 dark:text-gray-300 max-w-3xl animate-fade-in">
            ...
            <div className="flex items-center gap-4 mt-4 animate-fade-in">
              <a 
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-white dark:bg-gray-800 shadow-md hover:shadow-lg transition-all hover:scale-110"
...
export default Home;
  return (
    <div className="flex flex-col min-h-screen">
      <Header />
      <main className="flex-1">
        <section className="bg-gradient-hero py-20 dark:bg-gray-900">
          <div className="container mx-auto px-4">
            <h1 className="text-3xl md:text-4xl lg:text-5xl leading-tight font-serif font-bold text-black dark:text-gray-100 animate-fade-in">
              Insightful Political Analysis &<br />
              Geopolitical Commentary
            </h1>
            <p className="mt-6 text-base md:text-lg text-gray-700 dark:text-gray-300 max-w-3xl animate-fade-in">
